// Type definitions for node-ipc 9.1.1
// Project: http://riaevangelist.github.io/node-ipc/
// Definitions by: Dmitry Rodin <https://github.com/madiedinro> based on Arvitaly <https://github.com/arvitaly>
...
declare module 'node-ipc' {
  ...
  const RootIPC: NodeIPC.IPC & { IPC: new () => NodeIPC.IPC };
